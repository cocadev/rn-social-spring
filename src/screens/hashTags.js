...
export default class HashTags extends Component {
  ...
  onPrev() {
    ...
    const { description, colorIndex, profilePics, website } = navigation.state.params;
    const params = {
    ...
    return (
      <View style={theme.container}>
        <Header
          ...
          rightElement={<PreViewIcon navigation={navigation} onPrev={() => this.onPrev()} />}
        />
        ...
        <View style={styles.editView}>
          <TextInput
            ...
            onChangeText={x => x.split(' ').length < 6 && this.setState({ text: x })}
            value={text}
