  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        <Header title="Bernice Lucasy" leftElement={<BackIcon navigation={navigation} />} dark />
        ...
        <View style={{ flex: 1, marginTop: p(60), justifyContent: 'flex-end' }}>
          ...
          <View style={styles.inputBox}>
            ...
            <TouchableOpacity style={styles.btn} onPress={() => this.setState({ edit: true })}>
              <MaterialCommunityIcons name="text-shadow" size={p(24)} color={colors.GREY5} />
            </TouchableOpacity>
            <TouchableOpacity
