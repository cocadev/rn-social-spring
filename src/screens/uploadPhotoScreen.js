    ...
    return (
      <View style={theme.container}>
        <Header
          ...
          rightElement={
            <NextIcon navigation={navigation} onGoToHashTag={() => this.onGoToHashTag()} />
          }
          dark
        ...
        <View style={styles.editView}>
            ...
            {profilePics !== [] &&
              profilePics.map((item, index) => (
                <View style={{ marginHorizontal: p(5) }} key={index}>
                  ...
                  >
                    <MaterialCommunityIcons name="window-close" size={p(17)} color={colors.DARK} />
                  </TouchableOpacity>
                </View>
              ))}
            {profilePics.length < 4 && (
              <View style={styles.photoView}>
                <TouchableOpacity style={styles.photo} onPress={() => this.chooseFile()}>
                  <MaterialCommunityIcons name="plus" size={p(26)} color={colors.GREY6} />
                </TouchableOpacity>
              </View>
            )}
          </View>
          <TextInput
            style={[
              styles.input,
              colorIndex === 0 && { color: colors.DARK, borderBottomColor: colors.DARK },
            ]}
