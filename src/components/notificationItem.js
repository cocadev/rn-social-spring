        ...
        <View style={styles.content}>
          <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
            <View style={styles.cardContent}>
              ...
              <Text style={[styles.text1, !follow && { fontSize: 12 }]}>{item.time}</Text>
            </View>
            {follow && (
              <TouchableOpacity
                style={[
                  styles.round,
                  !item.resepect && { backgroundColor: colors.WHITE, borderWidth: 1 },
                ]}
                onPress={onRespect}
              >
                <Text style={[styles.respectText, !item.resepect && { color: colors.GREY9 }]}>
