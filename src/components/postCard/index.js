...
export default class PostCard extends Component {
  render() {
    ...
    return (
      <View style={[styles.row, { backgroundColor: UtilService.acceptColor(item) }]}>
        <View style={{ height: Platform.OS === 'ios' ? (ratio > 2 ? p(100) : p(60)) : p(60) }} />
        ...
        <View style={{ flexDirection: 'row' }}>
          ...
          <View style={styles.countView}>
            ...
            <Image source={images.share} style={[styles.crownImg, { height: 29, marginTop: 26 }]} />
          </View>
        </View>
        {item.description && <Text style={styles.normalText}>{item.description}</Text>}
