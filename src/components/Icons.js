...
export function SettingIcon() {
  return <Ionicons name="md-settings" size={24} color={colors.WHITE} style={{ marginTop: 3 }} />;
}

export function RightIcon() {
  return <Image source={images.messages} style={{ width: 20, height: 16, marginTop: p(7) }} />;
}
...
export function NextIcon(props) {
  ...
  return (
    <TouchableOpacity onPress={onGoToHashTag}>
      <Text
        style={{ fontSize: 14, lineHeight: 21, fontFamily: 'Poppins-Regular', color: colors.SKY }}
      >
        Next
      </Text>
    </TouchableOpacity>
...
export function PreViewIcon(props) {
  ...
  return (
    <TouchableOpacity onPress={onPrev}>
      <Text
        style={{ fontSize: 14, lineHeight: 18, fontFamily: 'Poppins-Regular', color: colors.SKY }}
      >
        View
      </Text>
    </TouchableOpacity>
